  ...
  return (
    <>
      ...
      >
        ...
        >
          <a className="flex items-center ps-2.5 mb-10 justify-center">
            <img src={sfLogo} className="h-6 me-3 sm:h-7" alt="Flowbite Logo" />
          </a>
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                href="#"
                className="mt-20 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
